...
class MedicalCard(models.Model):
    ...
    doctor_id = models.ForeignKey(Psyholog, on_delete=models.CASCADE)
    user_id = models.OneToOneField(TenantUser, on_delete = models.CASCADE)
...
class Appointment(models.Model):
    #id = models.AutoField(primary_key=True)
    medicalcard_id = models.ForeignKey(MedicalCard, on_delete=models.CASCADE)
    doctor_id = models.ForeignKey(Psyholog, on_delete=models.CASCADE)
    time = models.DateTimeField()
    diagnosis = models.CharField(max_length=255, verbose_name=u"diagnosis", null=True)
